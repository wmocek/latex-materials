...
\usepackage{amssymb}
\usepackage{tikz}
% For including images on slides
\usepackage{graphicx}
...
\begin{frame}
    \titlepage
    \note{
        Przedstaw się, nazywam się Wojciech Mocek, jestem biomatematykiem, sporo przepracowałem na uczelniach itd. itp. Przywitaj się z grupą, zapytaj jak minął dzień. Przedstaw się, zrób to na wesoło. :-) 
...
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=south east, inner sep=10pt] at (current page.south east) {
    \includegraphics[height=2.5cm]{images/mile_marker.png}
  };
\end{tikzpicture}
\vspace*{-0.3em}
...
\begin{tikzpicture}[scale=1.2, every node/.style={font=\normalsize}]
  ...
  \draw[-{Latex[length=3mm]}, line width=1.2pt] (-5.5,0) -- (4.8,0);
  ...
  % Decorative brace
  \draw[decorate, decoration={brace, amplitude=8pt}, line width=1pt]
...
% Top-right image (put your image file in images/mile_marker.png)
\begin{flushright}
  \includegraphics[height=2.6cm]{images/mile_marker.png}
\end{flushright}
\vspace{-2em}
\[
\sqrt{x^2}=|x|
...
%\]
\note{
Rozwiąż równanie i nierówności na odległościach.
}
\end{frame}
...
\note{
Rozwiąż równanie i nierówności na przypadki. Wytłumacz skąd biorą się przypadki.
}
\end{frame}
...
\begin{minipage}{0.49\linewidth}
    \includegraphics[height=2.6cm]{images/krak.png}
\end{minipage}%
\hfill
\begin{minipage}{0.49\linewidth}
    \begin{flushright}
      \includegraphics[height=2.6cm]{images/zakop.png}
    \end{flushright}
\end{minipage}
%\vspace{-0.5em}
...
\end{frame}
% ---------- FRAME 7 ----------
\begin{frame}{Rozwiązywanie równań kwadratowych bez delty}
% Top-right image (put your image file in images/mile_marker.png)
\begin{flushright}
  \includegraphics[height=3.6cm]{images/zmar.png}
\end{flushright}
\vspace{-8em}
\[
x^2-2x-3=0
...
% Top-right image (put your image file in images/mile_marker.png)
\begin{flushright}
  \includegraphics[height=2.6cm]{images/taxi.png}
\end{flushright}
\vspace{-2em}
